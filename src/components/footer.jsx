...
function Sitemap() {
  return (
    <>
      <div>
        <SitemapLinks>
          <SitemapLink href="#about">Про мене</SitemapLink>
        </SitemapLinks>
      </div>
      <div>
        <SitemapLinks>
          <SitemapLink href="#services">Послуги</SitemapLink>
        </SitemapLinks>
      </div>
      <div>
        <SitemapLinks>
          <SitemapLink href="#testimonials">Відгуки</SitemapLink>
        </SitemapLinks>
      </div>
      <div>
        <SitemapLinks>
          <SitemapLink href="#blog">Блог</SitemapLink>
        </SitemapLinks>
      </div>
      <div>
        <SitemapLinks>
          <SitemapLink href="#contact">Контакти</SitemapLink>
        </SitemapLinks>
      </div>
    </>
  )
